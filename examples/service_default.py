...
app = Celery(
    ...
    task_queues=[
        kombu.Queue(name='celery', routing_key='celery'),
        kombu.Queue(name='celery.example_queue_1', routing_key='celery.example_queue_1'),
        kombu.Queue(name='celery.example_queue_2', routing_key='celery.example_queue_2'),
        kombu.Queue(name='celery.example_queue_3', routing_key='celery.example_queue_3'),
    ],
    task_routes={
        '*test_succeeded_*': {'queue': 'celery.example_queue_1'},
        '*test_failed_*': {'queue': 'celery.example_queue_2'},
        '*test_retried': {'queue': 'celery.example_queue_3'},
    },
)
